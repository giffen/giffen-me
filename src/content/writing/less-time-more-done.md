...
description: "How having two hours a day in my 40s made me more productive than having all the time in the world in my 20s."
date: "2026-02-15"
tag: "Musing"
excerpt: "I have about two free hours a day. I'm in my 40s with a toddler and a full-time job. And I'm getting more done now than I ever did in my 20s, when I had entire weekends with nothing on the calendar. That math shouldn't work, but it does."
---
...
In those two hours, over the past year or so, I've learned to play the drums, set up a home lab server with automated backups and media streaming, and shipped [Brown Note](https://brownnote.app) — a full-stack web app with a REST API, a mobile app for iOS and Android, push notifications, social auth, and a sticker economy. I also wrote [a case study about it](/writing/building-brown-note).
...
AI — specifically Claude — has fundamentally changed what's possible in a two-hour coding session. I wrote about [my workflow](/writing/ai-development-workflow) in detail, but the short version is: I can describe a feature in plain English and have working, tested code in an hour. That's not an exaggeration. The My Replies feature I shipped last night — views, templates, URL patterns, navigation updates, 15 tests, all passing — took one session.
